    ...
    <Row>
      <Col md="8">
        <h2 data-cy="locationDetailsHeading">
          <Translate contentKey="jappApp.location.detail.title">Location</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="city">
              <Translate contentKey="jappApp.location.city">City</Translate>
            </span>
          </dt>
          ...
          <dt>
            <Translate contentKey="jappApp.location.country">Country</Translate>
          </dt>

...
@RestController
@RequestMapping("/api/japp-kafka")
public class JappKafkaResource {

    private static final String PRODUCER_BINDING_NAME = "binding-out-0";

    private static final Logger LOG = LoggerFactory.getLogger(JappKafkaResource.class);
    private final KafkaConsumer kafkaConsumer;
    private final StreamBridge streamBridge;

    public JappKafkaResource(StreamBridge streamBridge, KafkaConsumer kafkaConsumer) {

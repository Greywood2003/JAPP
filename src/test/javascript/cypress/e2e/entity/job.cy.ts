...
describe('Job e2e test', () => {
  ...
  describe('new Job page', () => {
    ...
    it('should create an instance of Job', () => {
      cy.get(`[data-cy="jobTitle"]`).type('Product Directives Producer');
      cy.get(`[data-cy="jobTitle"]`).should('have.value', 'Product Directives Producer');

      cy.get(`[data-cy="minSalary"]`).type('20088');
      cy.get(`[data-cy="minSalary"]`).should('have.value', '20088');

      cy.get(`[data-cy="maxSalary"]`).type('18723');
      cy.get(`[data-cy="maxSalary"]`).should('have.value', '18723');

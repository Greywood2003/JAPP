...
describe('Department e2e test', () => {
  ...
  const departmentSample = { departmentName: 'gripping' };
  ...
  describe('new Department page', () => {
    ...
    it('should create an instance of Department', () => {
      cy.get(`[data-cy="departmentName"]`).type('provided oof');
      cy.get(`[data-cy="departmentName"]`).should('have.value', 'provided oof');

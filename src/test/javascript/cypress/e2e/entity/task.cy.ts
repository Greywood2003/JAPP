...
describe('Task e2e test', () => {
  ...
  describe('new Task page', () => {
    ...
    it('should create an instance of Task', () => {
      cy.get(`[data-cy="title"]`).type('yuck hydrant geez');
      cy.get(`[data-cy="title"]`).should('have.value', 'yuck hydrant geez');

      cy.get(`[data-cy="description"]`).type('pliers');
      cy.get(`[data-cy="description"]`).should('have.value', 'pliers');

...
describe('Employee e2e test', () => {
  ...
  describe('new Employee page', () => {
    ...
    it('should create an instance of Employee', () => {
      cy.get(`[data-cy="firstName"]`).type('Mike');
      cy.get(`[data-cy="firstName"]`).should('have.value', 'Mike');

      cy.get(`[data-cy="lastName"]`).type('Mueller');
      cy.get(`[data-cy="lastName"]`).should('have.value', 'Mueller');

      cy.get(`[data-cy="email"]`).type('Dannie_Prosacco@gmail.com');
      cy.get(`[data-cy="email"]`).should('have.value', 'Dannie_Prosacco@gmail.com');

      cy.get(`[data-cy="phoneNumber"]`).type('since');
      cy.get(`[data-cy="phoneNumber"]`).should('have.value', 'since');

      cy.get(`[data-cy="hireDate"]`).type('2025-05-22T03:08');
      cy.get(`[data-cy="hireDate"]`).blur();
      cy.get(`[data-cy="hireDate"]`).should('have.value', '2025-05-22T03:08');

      cy.get(`[data-cy="salary"]`).type('22096');
      cy.get(`[data-cy="salary"]`).should('have.value', '22096');

      cy.get(`[data-cy="commissionPct"]`).type('5484');
      cy.get(`[data-cy="commissionPct"]`).should('have.value', '5484');

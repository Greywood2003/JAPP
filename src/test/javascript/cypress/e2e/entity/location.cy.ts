...
describe('Location e2e test', () => {
  ...
  describe('new Location page', () => {
    ...
    it('should create an instance of Location', () => {
      cy.get(`[data-cy="streetAddress"]`).type('mummify foot legend');
      cy.get(`[data-cy="streetAddress"]`).should('have.value', 'mummify foot legend');

      cy.get(`[data-cy="postalCode"]`).type('whoa bah');
      cy.get(`[data-cy="postalCode"]`).should('have.value', 'whoa bah');

      cy.get(`[data-cy="city"]`).type('South Mossiecester');
      cy.get(`[data-cy="city"]`).should('have.value', 'South Mossiecester');

      cy.get(`[data-cy="stateProvince"]`).type('seemingly toward cautiously');
      cy.get(`[data-cy="stateProvince"]`).should('have.value', 'seemingly toward cautiously');
